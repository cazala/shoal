...
const toDeg = (rad) => rad / (Math.PI * 2) * 360;
export const Fish = (props) => {
    ...
    return (createElement("cone", { key: id, position: { x, y, z }, rotation: { z: toDeg(angleZ) - 90, y: toDeg(angleY), x: 0 }, scale: mass * mass / 10, segmentsRadial: 3, transition: {
