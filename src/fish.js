...
Fish.prototype = {
  ...
  avoid: function(fishList, dist) {
    ...
    if (Fish.showBehavior) this.color = 'blue'
  },
  ...
  eat: function(fishList) {
    ...
    if (Fish.showBehavior) this.color = 'red'
  },
  ...
  mate: function(fishList, seaPopulation) {
    ...
    if (Fish.showBehavior) this.color = 'pink'
  },
  ...
  draw: function(ctx) {
    ...
    if (this.energy < 0) this.color = 'black'

    if (Fish.showBehavior && this.mature) this.color = 'pink'
